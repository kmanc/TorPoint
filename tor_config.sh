...
# And Thomas's project on https://hackaday.io/project/4223-raspberry-tor-router
...
echo "$(tput setaf 6)This script will auto-setup an Pi Tor proxy for you.$(tput sgr0)"
